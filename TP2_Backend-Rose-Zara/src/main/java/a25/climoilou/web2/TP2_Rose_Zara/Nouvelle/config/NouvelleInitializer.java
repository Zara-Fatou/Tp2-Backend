package a25.climoilou.web2.TP2_Rose_Zara.Nouvelle.config;
...
public class NouvelleInitializer {
    ...
    private static final Logger log = LoggerFactory.getLogger(NouvelleInitializer.class);

    private final NouvelleRepository nouvelleRepository;

    public NouvelleInitializer(NouvelleRepository nouvelleRepository) {
